export const PL = {
    ...
    InputCapacityPerCycle: "Pojemność wejściowa na cykl",
    Output: "Produkuje",
    OutputCapacity: "Pojemność wyjściowa",
    OutputCapacityPerCycle: "Pojemność wyjściowa na cykl",
    ...
    CannotSellBuilding: "W tej chwili nie można sprzedać tego budynku",
    ...
    InterestRate: "Odsetkowa stopa oprocentowania",
    InterestRateDesc: "Odsetki, które zarabiasz na kapitalizacji rynkowej, gdy jesteś offline",
    ...
    NotEnoughBuildingPermit: "Nie masz wystarczająco pozwoleń na budowę. Kup więcej, aby zbudować nowe budynki",
    MovingAverage: "Średnia ruchoma",
    MovingAverageDesc: "Pokaż średnią ruchomą zmian zasobów zamiast zmian w czasie rzeczywistym",
    AllowZoom: "Przybliżenie",
    AllowZoomDesc: "Włącz obsługę zbliżania. Użyj kółka myszy, aby powiększyć. Aktualne zbliżenie to %{zoom}",
    AllowZoomMobileDesc: "Włącz obsługę zbliżania. Możesz uszczypnąć, aby powiększyć. Aktualne zbliżenie to %{zoom}",
    Settings: "Ustawienia",
    ...
    Reward: "Nagroda",
    PerSecond: "%{time}/s",
    PerCycle: "%{amount}/cykl",
    PolicyPoint: "Punkty patentowe",
    PolicyPointPerMinute: "Szybkość generowania",
    PolicyPointPerMinuteDesc: "Punkty patentowe zdobywasz co minutę w grze",
    YourWilLGaimPolicyPoints: "Otrzymasz %{amount} punktów patentowych w %{time}s",
    ...
    WholesaleCenterLocked:
        "Potrzebujesz %{required} różnych surowców żeby odblokować Hurtownie. Masz tylko %{current} surowców",
    OrderFilled: "zlecenie od %{from} zostało pomyślnie wypełnione!",
    PolicyCenter: "Centrum Strategii",
    NewOrder: "Nowe zlecenie od %{from} zostało złożone, sprawdź w Hurtowni",
    Policies: "Strategie",
    PolicyNotEnoughTime: "Nie masz wystarczającej ilości punktów strategii dla tej strategii",
    TimeLeft: "%{time} Pozostało",
    WholesaleCenterOrderFasterDesc: "Hurtownia otrzymuje zlecenia 2x szybciej oraz wielkość zleceń jest 2x większa",
    PolicyOilWellPowerx2: "Doładowanie Szybu Naftowego",
    PolicyOilWellPowerx2Desc: "Szyby naftowe produkują 2x ropy I zużywa 2x energii",
    HalfTransportSpeed: "Zwolnij żeby zaosczędzić",
    HalfTransportSpeedDesc: "Prędkość transportu jest mniejsza o 25% zużycie paliwa jest mniejsze o 25%",
    RefineryMoreOil: "Więcej Paliwa Więcej Problemów",
    RefineryMoreOilDesc: "Rafinerie ropy naftowej podukują 50% więcej benzyny I 50% mniej plastiku",
